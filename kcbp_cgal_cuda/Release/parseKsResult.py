...
for line in inputfile.readlines():
    ...
    if line.find('K = ') == 0: #find k
        k = line[len('K = '):len(line)-1]
...
simpleresultfile.write('k, ConstructKCBP, ConstructModelAABB, init-CD(kCBP-aabb), init-CD(kCBP-GJK), count(kCBP), count(real)\n')
