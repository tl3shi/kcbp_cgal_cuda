...
#alice-k24-model10.AABB.1.log.result.simple
#alice-k24-model10.gjk.2.log.result.simple
...
#    model = 'bunny2'
    ...
    header = []
    for i in range(1, 6):
        gjkfilename = model + '-k24-model10.gjk.' + str(i) + '.log.result.simple.csv'
        aabbfilename = model + '-k24-model10.AABB.' + str(i) + '.log.result.simple.csv'
