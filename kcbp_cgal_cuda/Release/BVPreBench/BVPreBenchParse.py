...
features_key  = ['CT(Box)', 'CT(Sphere)', 'CT(kDop)', 'CT(kCBP)', 'CT(Convexhull)', 'init(Box)', 'init(Sphere)', 'init(kDop)', 'init(kCBP)', 'init(Convexhull)', 'CD(Box)', 'CD(Sphere)', 'CD(kDop)', 'CD(kCBP)', 'CD(Convexhull)', 'hitRate(Box)', 'hitRate(Sphere)', 'hitRate(kDop)', 'hitRate(kCBP)', 'hitRate(Convexhull)', 'initAfterBox(kDop)', 'initAfterBox(kCBP)', 'initAfterBox(Convexhull)', 'CDAfterBox(kDop)', 'CDAfterBox(kCBP)', 'CDAfterBox(Convexhull)', 'ModelCDNum','point', 'triangle'] 
features_value= ['boundingbox for models time', 'boundingSphere for models time', 'kDOP for models time', 'kCBP for models time', 'convexhull for models time', 'Box init time', 'Sphere init time', 'kDOP init time', 'kCBP init time', 'Convexhull init time', 'Box directly cd time', 'Sphere directly cd time', 'kDOP cd time', 'kCBP cd time', 'Convexhull cd time', 'Box hit rate', 'Sphere hit rate', 'kDOP hit rate', 'kCBP hit rate ', 'Convexhull hit rate', 'kDOP init time(AfterBox)', 'kCBP init time(AfterBox)', 'Convexhull init time(AfterBox)', 'kDOP cd time(AfterBox)', 'kCBP cd time(AfterBox)', 'Convexhull cd time(AfterBox)','Model collision pair by Box','points number:','triangle number:'] 
