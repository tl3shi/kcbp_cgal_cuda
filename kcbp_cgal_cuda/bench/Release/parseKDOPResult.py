...
features_key  = ['init(kDOPTree)', 'CD(kDOPTree)', 'count(Box)', 'count(real)'] 
features_value= ['build time(kDOP):', 'total collision time(kDOP)', 'box collision size', 'collision pairs']
