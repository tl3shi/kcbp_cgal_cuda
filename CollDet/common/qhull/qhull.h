...
-FOREACHvertex_(vertice)     iterate over vertex set (uses 'vertexT **vertexp' & uses 'vertexT *vertex')
-FOREACHqh_vertex_(vertice)  iterate over vertex set (uses 'vertexT **qh_vertexp' & 'vertexT *qh_vertex')
...
#define FOREACHqh_vertex_(vertices) FOREACHsetelement_(vertexT, vertices, qh_vertex)
