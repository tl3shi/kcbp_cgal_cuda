/* qhull_io.c - Input/Output routines of qhull application

   see README and qhull_io.h
   
   see user.c for qh_errprint and qh_printfacetlist

   unix.c calls qh_readpoints and qh_produce_output
   
   unix.c and user.c are the only callers of qhull_io.c functions
   This allows the user to avoid loading qhull_io.o from qhull.a
...
void qh_printfacet2geom(FILE *fp, facetT *facet, realT color[3]) {
  ...
  /*
    assume precise calculations in qhull_io.c with roundoff covered by qh_GEOMepsilon
    mindist is calculated within qhull_io.c.  maxoutside is calculated elsewhere
